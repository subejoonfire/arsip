...
<div class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Arsip</h2>

    <form action="<?= base_url('admin/arsip/update/' . $arsip['id']) ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_box" id="nama_box"
                ...
                value="<?= esc($arsip['nama_box']) ?>" required>
        </div>
